    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <table id="table" class="table table-bordered">
          ...
          <tbody>
            <?php
            $query = $conn->query("SELECT * FROM book NATURAL JOIN user_book NATURAL JOIN rooms NATURAL JOIN pack WHERE `status` = 'Enregistrer'") or die(mysqli_query());
            ...
            ?>
              <tr>
                ...
                <td>
                  <center><a class="btn btn-warning" href="checkout_query.php?book_id=<?php echo $fetch['book_id'] ?>" onclick="confirmationCheckin(); return false;"> Quitter </a></center>
                </td>
              </tr>
            <?php
            }
