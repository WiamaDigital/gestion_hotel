  ...
  <div class="contenu-footer">
    ...
    <div class="boite">
      ...
      <div class="menu-deroulant">
        ...
        <div class="contenus">
          <a href="./room/home_room.php"> <i class="fas fa-angle-right"></i> Hébergement</a>
          <a href="./resto/resto.php"> <i class="fas fa-angle-right"></i> Restaurant</a>
          <a href="./activite/activ.php"> <i class="fas fa-angle-right"></i> Activités</a>
        </div>
