...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Les données ne sont pas disponibles dans le tableau" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default  les données ne sont pas disponibles dans le tableau
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "les données ne sont pas disponibles dans le tableau"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Les données ne sont pas disponibles dans le tableau",
